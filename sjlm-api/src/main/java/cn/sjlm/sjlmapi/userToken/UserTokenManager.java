package cn.sjlm.sjlmapi.userToken;

import java.time.LocalDateTime;
import java.util.HashMap;
import java.util.Map;

import cn.sjlm.sjlmapi.userToken.*;
import cn.sjlm.sjlmapi.util.*;

/**
 * 维护用户token
 */
public class UserTokenManager {
    private volatile static Map<String, UserToken> tokenMap = new HashMap<>();
    private volatile static Map<Integer, UserToken> idMap = new HashMap<>();
